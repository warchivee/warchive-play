...
const questions: Category[] = [
	{
		...
		question: [
			{
				text: `다음은 귀신이 된 주인공 박자언이 극락왕생을 하기 위해 고등학생 시절로 되돌아가 여러 기묘한 존재들과 만나게 되며 생기는 다양한 에피소드를 이야기하는 판타지 웹툰 〈극락왕생〉에 등장하는 캐릭터 도명의 대사이다. 빈칸에 들어갈 단어로 알맞은 것을 고르시오.`,
	...
	},
	{
		...
		question: [
			{
				text: `남성 주연의 영화를 미러링해 리부트한 코미디 SF 영화 〈고스트 버스터즈(2016)〉에는 괴현상을 해결하기 위해 모인 물리학 박사, 초자연 현상 전문가, 무기 개발자, 지하철 역무원 등 매력적인 여성 주인공들이 등장한다. 이 영화의 주인공은 전부 몇 명인가?`,
			...
			{
				text: `넷플릭스 오리지널 예능 〈사이렌: 불의 섬〉은 소방관, 경찰관, 경호원, 군인, 운동선수, 스턴트 배우인 여성 24명이 직업군별로 팀을 이뤄 경쟁하는 서바이벌 리얼리티 프로그램이다. 다음 중 운동선수 팀원들의 종목으로 알맞지 <u><strong>않은</strong></u> 것을 고르시오.`,
			...
			{
				text: `영화 〈에브리씽 에브리웨어 올 앳 원스〉 모녀간의 사랑과 갈등을 멀티버스라는 독특한 소재로 풀어낸 SF 액션 코미디 영화다. 다음은 여러 멀티버스 세계의 에블린(양자경 분)을 나열한 것이다. 이 중 옳지 <u><strong>않은</strong></u> 것을 고르시오.`,
				answer_type: 'long',
				answers: [
					{
						number: 1,
	...
	},
	{
		...
		question: [
			...
			},
			{
				...
				example: {
					type: 'lefted',
					text: '여기선 사과는 누가 해야할까<br />실수로 그랬거나 일부러 그랬겠지<br />아님 자기가 그런줄 모를 수도<br />우리 모두 ( &emsp;&emsp; ) 탄 물을 마신거야<br />( &emsp;&emsp; ) 마시면 ( &emsp;&emsp; ) 취하지 어쩌겠어'
				},
				answers: [
					{
						number: 1,
