...
const questions: { category: string; questions: { text: string; image?: { type: number; add: string; }; example?: { type: number; text: string; }; answers: { number: number; text: string;}[]; correctAnswers: number[] }[] }[] = [
    {
        category: '만화',
        questions: [
            {
                ...
                example: { type: 1, text: '수리수리 마하수리 수수리 사바하.<br />길어져라 ( &emsp;&emsp; ) 석장.' },
				answers: [
					{
						number: 1,
                        text: '감나무',
                ...
                example: { type: 1, text: '내 이름은 파르페야.<br />나는 백포도 왕국의 왕 ( &emsp;&emsp; )가 아니라 합법해적 파르페를 선택하기로 했고 후회는 없어.'},
				answers: [
					{
						number: 1,
                        text: '미네르바',
        ...
        questions: [
            {
                ...
                example: { type: 2, text: '여기선 사과는 누가 해야할까<br />실수로 그랬거나 일부러 그랬겠지<br />아님 자기가 그런줄 모를 수도<br />우리 모두 ( &emsp;&emsp; ) 탄 물을 마신거야 ( &emsp;&emsp; ) 마시면 ( &emsp;&emsp; ) 취하지 어쩌겠어'},
				answers: [
					{
						number: 1,
                        text: '술',
                ...
                example: { type: 2, text: '너는 누구<br />너는 무엇<br />너의 또 다른 이름은 나<br />넌 이상한 ( &emsp;&emsp; )야<br />넌 떠도는 이민자<br />넌 설쳐대는 폴렉<br />내 이름 없었지<br />홀로 작은 유성처럼 떠다니는 짙고 푸른 너<br />제 몸에 상처를 내어 폭발하는 독하고 모난 나' },
				answers: [
					{
						number: 1,
                        text: '괴짜',
